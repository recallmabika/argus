...
export const MetricsRibbon: React.FC<MetricsRibbonProps> = ({ stats, deviceCount, auditCount }) => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
      ...
      {/* Audit Compliance */}
      <div className="col-span-2 sm:col-span-1 bg-white dark:bg-cyber-card border border-slate-200 dark:border-cyber-700/60 rounded-sm p-4 flex flex-col justify-between shadow-xs">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            Audit Logged
          </span>
